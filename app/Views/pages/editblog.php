...
<section>
      <div class="row m-0 g-0">
        ...
        <div class="col-sm-9 bg_two">
            ...
            <h3 class="text-center pt-5 mb-3" id="changeTitle">修改文章</h3>

            <div class="p-5 mx-5">
                <form action="" method="post" id="createForm">
                        <div class="form-group row mb-3 d-none">
                            <div class="col-4">
                                <label for="blogID">文章ID</label>
                            </div>
                            <div class="col-8">
                                <input type="text" name="blogID" id="blogID" class="form-control" disabled value="<?= esc($blogs['id'])?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-8">
                                <input type="text" name="title" id="title" class="form-control" value="<?= esc($blogs['title'])?>" required>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <div class="col-4">
                            ...
                            <div class="col-8">
                                <input type="text" name="category" id="category" class="form-control" disabled value="<?= esc($blogs['category'])?>">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <div class="col-4">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-8">
                                <textarea  name="content"id="content" class="form-control" rows="10" required><?= esc($blogs['content'])?></textarea>
                            </div>
                        </div>    
                        <br>
                        <div class="row mb-3  justify-content-center">
                            <button type="submit" name="submit" id="button" class="btn btn-primary col-2" onclick="doEdit()">更新</button>
                        </div>
                    </form>
